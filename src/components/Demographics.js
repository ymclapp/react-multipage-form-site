...
export default function Demographics() {
    ...
    return (
        <Container className='showDemographics mt-4'>
            ...
            <li>Attendee Id:  {demographic.attributes.id}{demographic.attributes.address}, {demographic.attributes.city}, {demographic.attributes.state}  {demographic.attributes.zip}</li>)}
            </ul> */}
        </Container >
